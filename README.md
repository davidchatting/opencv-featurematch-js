...
// -> { valid: true, transform: [16 numbers, row-major 4x4], transform2D: [a, b, c, d, e, f], inlierMatches: [...26 pairs...], outlierMatches: [...], reason: 'OK' }
```
